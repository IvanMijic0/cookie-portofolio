			...
			<div className="flex justify-between gap-4 items-start">
				<header>
					<h1 className="flex flex-col gap-6 italic" itemProp="headline">
						<span
							...
							{t("graphicDesignOne.title.titleOne", "Festival Art Direction Proposal")}
						</span>
						<span
							...
							{t("graphicDesignOne.title.titleBrand", "KREATIV fest")}
						</span>
						<span
							...
							{t("graphicDesignOne.title.titleTwo", "Kreativ Euphoria")}
						</span>
					</h1>
				</header>
				<section className="w-64" itemProp="description">
					<p className="[text-shadow:_0_8px_24px_rgba(0,0,0,.45)] text-sm 2xl:text-base font-serif text-justify font-bold italic">
						...
						. {t(
							"graphicDesignOne.subText",
							"KREATIV fest gave the opportunity to the students to showcase their creativity through art direction of the festival."
						)}					</p>
				</section>
			</div>
		</article>
		...
		<RightPage ref={ref} showBookmark>
			...
			>
				...
				<h1 className="sr-only" itemProp="headline">
					{t("graphicDesignOne.meta.simpleName", "KREATIV fest — Kreativ Euphoria (Visual Identity Proposal)")}
				</h1>
				...
				>
					<p className="text-sm 2xl:text-lg font-bold italic">
						{t(
							"graphicDesignOne.text.textOne",
							"As a submission for the 2024 Kreativ Fest art direction at International Burch University, this visual identity proposal draws heavily from grunge aesthetics and the experimental legacy of David Carson."
						)}
					</p>
					<p className="text-xs 2xl:text-base">
						{t(
							"graphicDesignOne.text.textTwo",
							"Centered around a custom logotype reading “Kreativ Euphoria,” the design uses negative-space lettering and a stamp-like composition to reflect the chaotic, expressive energy of young creatives."
						)}
					</p>
					<p className="text-xs 2xl:text-base">
						{t(
							"graphicDesignOne.text.textThree",
							"The visual language is built on a contrast of vivid neon green, pink, and orange against stark black overlays, creating a dynamic, high-impact look that feels both nostalgic and fresh. The textures and layering mimic ripped posters and street art, reinforcing a raw, urban atmosphere."
						)}
					</p>
					<p className="text-xs 2xl:text-base">
						{t(
			...
			>
				...
				>
					<button
						...
						aria-label={t("graphicDesignOne.aria.openHero", "Open hero poster in lightbox")}
				...
				>
					...
					>
						{t(
							"graphicDesignOne.mobileIntro",
							"Submission for the 2024 Kreativ Fest art direction at International Burch University. A grunge-influenced identity that channels the experimental spirit of David Carson with layered textures, bold typography, and neon accents."
						)}
					</p>
					...
					<div className="flex w-full gap-2 pt-6" itemProp="hasPart">
						<div className="flex flex-col flex-1 gap-2">
							<figure itemScope itemType="https://schema.org/ImageObject" className="m-0">
								<button
									...
									onClick={() => openAt(1)}
									className="block w-full cursor-zoom-in"
									aria-label={t("graphicDesignOne.aria.openIdFront", "Open ID badge front in lightbox")}
								...
								>
									<img
										...
										loading="lazy"
										decoding="async"
										alt={t("graphicDesignOne.mobileSlides.idFrontAlt", "Kreativ Fest ID badge — front side with custom logotype.")}
										itemProp="contentUrl"
										width={1200}
										height={1600}
									/>
								...
								<figcaption className="sr-only" itemProp="caption">
									{t("graphicDesignOne.mobileSlides.idFrontCaption", "ID badge front mockup.")}
								</figcaption>
							</figure>
							...
							<figure itemScope itemType="https://schema.org/ImageObject" className="m-0">
								<button
									...
									onClick={() => openAt(2)}
									className="block w-full cursor-zoom-in"
									aria-label={t("graphicDesignOne.aria.openIdBack", "Open ID badge back in lightbox")}
								...
								>
									<img
										...
										loading="lazy"
										decoding="async"
										alt={t("graphicDesignOne.mobileSlides.idBackAlt", "Kreativ Fest ID badge — back side with typographic grid.")}
										itemProp="contentUrl"
										width={1200}
										height={1600}
									/>
								...
								<figcaption className="sr-only" itemProp="caption">
									{t("graphicDesignOne.mobileSlides.idBackCaption", "ID badge back mockup.")}
								</figcaption>
							</figure>
						</div>
						...
						>
							<button
								...
								onClick={() => openAt(3)}
								className="block w-full cursor-zoom-in"
								aria-label={t("graphicDesignOne.aria.openBooklet", "Open program booklet in lightbox")}
							...
							>
								<img
									...
									loading="lazy"
									decoding="async"
									alt={t("graphicDesignOne.mobileSlides.bookletAlt", "Kreativ Fest program booklet cover design.")}
									itemProp="contentUrl"
									width={1400}
									height={1600}
								/>
							...
							<figcaption className="sr-only" itemProp="caption">
								{t("graphicDesignOne.mobileSlides.bookletCaption", "Program booklet cover.")}
							</figcaption>
						</figure>
					</div>
					...
					>
						<p className="text-base" itemProp="about">
							{t(
								"graphicDesignOne.short.textTwo",
								"Built around a custom “Kreativ Euphoria” logotype, the identity leverages negative space, stamp-like marks, and ripped-poster textures to express youthful, chaotic energy."
							)}
						</p>
						<p className="text-base">
							{t(
								"graphicDesignOne.short.textThree",
								"A vivid palette of neon green, pink, and orange pushes against deep blacks and layered overlays for a tactile, urban look that feels both nostalgic and fresh."
							)}
						</p>
						<p className="text-base">
							{t(
								"graphicDesignOne.short.textFour",
								"The system adapts across posters, leaflets, and social media while preserving a cohesive, hand-made aesthetic."
							)}
						</p>
						<p className="text-base">
							{t(
								"graphicDesignOne.short.textFive",
								"The concept embraces imperfection and spontaneity — it doesn’t just promote an event; it embodies its energy."
							)}
						</p>
					</section>
					...
					>
						...
						<Carousel items={slides as any} loop rounded aria-label={t("common.relatedWorks", "Related works carousel")} />
					</section>
				</article>
